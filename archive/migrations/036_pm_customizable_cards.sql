...
CREATE TABLE IF NOT EXISTS pm.card_templates (
  ...
  CONSTRAINT fk_card_template_tenant FOREIGN KEY (tenant_id) REFERENCES pm.tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS pm.user_views (
  ...
  CONSTRAINT fk_user_view_tenant FOREIGN KEY (tenant_id) REFERENCES pm.tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS pm.task_labels (
  ...
  CONSTRAINT fk_label_tenant FOREIGN KEY (tenant_id) REFERENCES pm.tenants(id) ON DELETE CASCADE,
