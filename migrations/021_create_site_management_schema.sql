-- ============================================================================
-- SITE MANAGEMENT & MULTI-DOMAIN SCHEMA
...
CREATE TABLE cms.sites (
  ...
  -- Constraints
  CONSTRAINT one_primary_per_tenant UNIQUE (tenant_id, is_primary)
...
CREATE INDEX idx_terms_path ON cms.terms USING gin(to_tsvector('simple', term_path));
