-- ============================================================================
-- TENANT PLANS & DATA ISOLATION CONFIGURATION
...
CREATE TABLE platform.tenant_subscriptions (
  ...
  tenant_id UUID NOT NULL UNIQUE, -- Un subscription per tenant
...
COMMENT ON TABLE platform.plan_migrations IS 'Storia migraz ioni tra piani (incluso cambio isolamento)';
